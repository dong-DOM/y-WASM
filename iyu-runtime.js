...
const IYU_VERSION = "3.0.1-wasm";
console.log("[iyu] iyu-runtime.js " + IYU_VERSION + "（无状态栏版）；若界面仍出现顶部蓝色状态栏，说明浏览器加载的是旧版文件缓存");
const IYUHost = {
...
let __frame = null;                   // 运行容器（无任何默认装饰样式）
...
function buildFrame() {
    ...
    __frame.style.cssText = `width:${__opts.width}px;height:${__opts.height}px;position:relative;overflow:hidden;
        ...
        font-size:14px;color:#333;user-select:none;box-sizing:border-box;`;
    __screen = document.createElement("div");
    __screen.className = "iyu-screen";
    __screen.style.cssText = `position:absolute;top:0;left:0;right:0;bottom:0;overflow:hidden;display:flex;flex-direction:column;`;
